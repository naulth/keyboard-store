        ...
        <header className="bg-white fixed w-full top-0">
            <nav className="mx-auto flex mx-w-7xl items-center justify-between h-24 gap-x-6 p-6 lg:px-8" aria-label="Global">
				<div className="flex lg:flex-1 mt-auto">
                    <Link className="text-3xl font-bold leading-6 tracking-tight text-slate-500" to="/">KeebFinder</Link>
				</div>
				<div className="hidden lg:flex lg:gap-x-12">
                    <NavLink className="text-lg font-semibold leading-6 text-slate-500" to="/feed" >100%</NavLink>
                    <NavLink className="text-lg font-semibold leading-6 text-slate-500" to="/users" end>TKL</NavLink>
                    <NavLink className="text-lg font-semibold leading-6 text-slate-500" to="/profile">75%</NavLink>
					<NavLink className="text-lg font-semibold leading-6 text-slate-500" to="/games" >60%</NavLink>
				</div>
                ...
                {user ? null : <Link to="/login" className="text-lg font-semibold leading-6 text-slate-500">Log In</Link> }
                {user ? null : <Link to="/signup" className="rounded-md bg-slate-500 px-3 py-2 text-md font-semibold text-white shadow-sm hover:bg-slate-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500">Sign up</Link> }
